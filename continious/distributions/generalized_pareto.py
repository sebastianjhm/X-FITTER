...
class GENERALIZED_PARETO:
    ...
    def get_parameters(self, measurements):
        ...
        def equations(sol_i, measurements):
            ...
            # eq1 = parametric_p25 - np.percentile(measurements.data, 25)
            eq3 = parametric_median - np.percentile(measurements.data, 50)
        ...
        if parameters["c"] < 0:
            ...
            b = ((-np.inf, -np.inf, 0), (np.inf, measurements.min, np.inf))
