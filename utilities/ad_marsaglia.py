...
def errfix(n, x):
    g1 = lambda t: math.sqrt(t) * (1 - t) * (49*t - 102)
    g2 = lambda t: -0.00022633 + (6.54034 - (14.6538 - (14.458 - (8.259 - 1.91864*t)*t)*t)*t)*t
    g3 = lambda t: -130.2137 + (745.2337 - (1705.091 - (1950.646 - (1116.360 - 255.7844*t)*t)*t)*t)*t
